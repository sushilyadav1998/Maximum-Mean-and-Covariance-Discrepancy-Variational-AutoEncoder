# -*- coding: utf-8 -*-
"""
Created on Mon Oct 19 21:05:14 2020
...
def plot_results(models,
    ...
    for i, yi in enumerate(grid_y):
        for j, xi in enumerate(grid_x):
            ...
            cv2.imwrite('VAE_XRay/xray.'+ str(i)+'.jpeg',255*digit)
    ...
    plt.show()
#%%
d1=r'C:\Users\sushilkumar.yadav\Desktop\vmware\Personal\Research\Image_recognition_in_wild_using_Deep_Learning\standard_database\X_ray_short'
Img_size = 64
